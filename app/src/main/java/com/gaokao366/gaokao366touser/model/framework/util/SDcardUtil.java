...
public class SDcardUtil {
     ...
     * 保存图片到SD卡�?
     * @param bitmap
     * @param fileDir 如：sensecp/pic
     * @param fileName 如：123.png
     */
    public static void saveBitmapToSDCard(final Bitmap bitmap,final String fileDir, final String fileName,final CompressFormat format){
    	/**
    	 * �?���?��异步线程去保存图�?
    	 */
    	new Thread(){
